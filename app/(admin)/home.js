/**
 * app/(admin)/home.js    Admin Dashboard
 *
 * IMPROVEMENTS:
 * - Auto-refresh when screen comes into focus (useFocusEffect)
 * - Better text contrast and visibility in both light & dark mode
 * - Bigger, bolder stat numbers and labels
