        ...
        {exams.length === 0 ? (
          <>
            <EmptyStateCard
              ...
              message="Add an exam in the Add Task screen (Category: Exam) and it will appear here for planning."
              icon="school-outline"
              style={{ marginTop: 8 }}
            />
            <View
            ...
            >
              ...
              >
                Tip: Go to Add Task, select Exam as category, then set your exam
                date.
              </Text>
            </View>
          </>
